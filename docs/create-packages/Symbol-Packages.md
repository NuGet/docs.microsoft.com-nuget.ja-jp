...
## <a name="creating-a-legacy-symbol-package"></a><span data-ttu-id="700a5-111">レガシ シンボル パッケージの作成</span><span class="sxs-lookup"><span data-stu-id="700a5-111">Creating a legacy symbol package</span></span>
