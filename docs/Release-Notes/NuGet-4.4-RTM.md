...
---
# <a name="44-rtm-release-notes"></a>4.4 RTM リリース ノート
...
* dotnet add package によって csproj から空の行が消去される場合があります - [#5697](https://github.com/NuGet/Home/issues/5697)
...
* TargetFramework と TargetFrameworks によって、dotnet pack の動作が異なります - [#5281](https://github.com/NuGet/Home/issues/5281)
...
## <a name="link-to-github-issues-fixed-in-44-rtm"></a>4.4 RTM で修正された GitHub の懸案事項へのリンク
