...
## <a name="configuring-the-packages-folder"></a><span data-ttu-id="f2fe3-153">パッケージ フォルダーを構成する</span><span class="sxs-lookup"><span data-stu-id="f2fe3-153">Configuring the Packages folder</span></span>
