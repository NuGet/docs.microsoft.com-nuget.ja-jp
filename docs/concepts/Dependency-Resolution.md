...
## <a name="managing-dependency-assets"></a><span data-ttu-id="c4d5e-173">依存関係アセットの管理</span><span class="sxs-lookup"><span data-stu-id="c4d5e-173">Managing dependency assets</span></span>
