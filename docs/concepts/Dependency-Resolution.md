...
## <a name="managing-dependency-assets"></a><span data-ttu-id="10238-174">依存関係アセットの管理</span><span class="sxs-lookup"><span data-stu-id="10238-174">Managing dependency assets</span></span>
