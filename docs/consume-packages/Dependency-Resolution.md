...
## <a name="managing-dependency-assets"></a><span data-ttu-id="1eea4-172">依存関係アセットの管理</span><span class="sxs-lookup"><span data-stu-id="1eea4-172">Managing dependency assets</span></span>
