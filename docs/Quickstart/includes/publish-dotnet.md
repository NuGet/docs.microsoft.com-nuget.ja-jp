1. <span data-ttu-id="a7582-101">`.nupkg` ファイルを含むフォルダーに変更します。</span><span class="sxs-lookup"><span data-stu-id="a7582-101">Change to the folder containing the `.nupkg` file.</span></span>
